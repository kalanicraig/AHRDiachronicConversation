...
[^1]: See Louis A. Pérez Jr., Cuba in American Imagination 
...
Many US historians working on this war focused on a portion of what had been a much longer conflict between Cuba and Spain that started in 1868. Encapsulating the event to 1898 not only iterates the claim that the United States became imperial by accident –provoked by the sinking of the USS Maine–and that, consequently, the country had to suddenly “learn” to become an empire after 1898.[]  In addition, such historiographical focus contributed to the labeling of the event as the “Spanish-American War” which erases Cubans as the protagonists in their own wars of independence.[]  An empire does not just “happen,” nor it becomes suddenly accepted and rallied by much of the US public at the time without an established ideological framework where those actions by the US government and military could be deemed logical and justifiable to the citizenry.[] 
...
Our dialogue-based triangulation included a number of conversations over the course of 2 days that identified a number of questions and patterns that required additional research and conversation. With Kalani focused on the historical trends in the corpus with little knowledge of the historical content, and Arlene focused on a selection of the primary sources as a historical content specialist, we formally set aside time for the sort of conversation that happens serendipitously in hallways at conferences, or the type of conversation that happens in scheduled time in history seminars. This interstitial historiographic seminar conversation that triangulates the separate methods analysis. The outcome of this stage should be a draft analysis documented clearly, either in the methods section or labeled as “in-progress” analysis in the results section.


Here, we reconsider several things: stop words (words that the computational analysis should ignore) or combining multi-word concepts (Dr. Hernandez, Mr. Hernandez, Francisco Hernandez = “FranciscoHernandez”) based on close-reading and the topics that come of computational distributional analysis; additional close-reading passages, areas of agreement or disagreement in interpretation drawn from both methods

We replicate some of those here in THIS EMBEDDED VIDEO THAT DOESN'T EXIST YET ![Arlene and Kalani, conversation and triangulation embedded video]({{ site.url }}{{ site.baseurl }}{{ site.urlimg }}/ZoomConvo.png)

Kalani saw: gendered nature of Flint’s writing.
Arlene saw: the hook. Use “clickbait” intentionally as an anachronism.

Together, we see: Amazons as a hook. It’s fine to report that there are women fighters–they exist and are part of the insurgency–but the combination of computational and close-reading analysis led us to this hook.
...
- "She" shows up with "machete". We explored some of the gendered structures in the text and found in Rea 136 an little Amazon with a machete (Dr. Hernandez' wife in Flint 124)
...
- impediment* = badly organized (swearing, clattering, according to Flint in 99 and 100), barriers, burdens

Flint (writes in 1896)
...
- "She" shows up (Madame Hernandez and Madam Gonzales) but CUBA is also a "she"
- "She" shows up with "machete". We explored some of the gendered structures in the text and found in Rea 136 an little Amazon with a machete (Dr. Hernandez' wife in Flint 124)
Rea (writes in 1896-7, publishes 1897)

Maceo is an avatar for Cubans in the topic model (shows up regularly with "cuban" and "cubans", topics 1,2,3, 7, 8). Gomez only shows up with concepts of Cubans as people when he is *with* Maceo; he's much more associated with Spain (Spain, Spanishl topics 6, 4).
